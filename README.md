...
Deployed Application (**required**):https://kudos-board-1-4pqr.onrender.com
...
Yes, it was enough. Wish we went over createContext and useContext though.
...
Everything went well, would use better UI though and make the search filter on each word typed as well.
